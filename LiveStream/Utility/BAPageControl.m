...
@property (nonatomic, assign) CGFloat indicatorMargin;          // 圆点边距
@property (nonatomic, assign) CGFloat indicatorWidth;           // 圆点宽度
@property (nonatomic, assign) CGFloat currentIndicatorWidth;    // 当前圆点宽度
@property (nonatomic, assign) CGFloat indicatorHeight;          // 圆点高度
...
- (instancetype)initWithFrame:(CGRect)frame indicatorMargin:(CGFloat)margin indicatorWidth:(CGFloat)indicatorWidth currentIndicatorWidth:(CGFloat)currentIndicatorWidth indicatorHeight:(CGFloat)indicatorHeight{
    if (self = [super initWithFrame:frame]) {
        ...
        _numberOfPages = 0;
        _currentPage = 0;
        _pageIndicatorColor = TIP_TEXT_COLOR;
